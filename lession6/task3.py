...
class Position(Worker):
    ...
    def get_total_income(self):
        return print(f'Его доход с учетом премии составляет: {self._income_wage + self._income_bonus} тыс. рублей.')


a = Position('Иван', 'Иванов', 'Бухгалтер', {'wage': 30000, 'bonus': 10000})
a.get_full_name()
